...
from .eval             import eval_cloze_accuracy, eval_exact_match, eval_token_f1, pretty_matrix  # noqa: E402
...
__all__ = [
    ...
    "eval_cloze_accuracy", "eval_exact_match", "eval_token_f1", "pretty_matrix",
