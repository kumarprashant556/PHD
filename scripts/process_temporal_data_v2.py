...
Small CC-News smoke run:
    ...
    python scripts/process_temporal_data_v2.py cc_news --force --max-docs-per-period 200

Full CC-News v2 processing from the local raw file:

    python scripts/process_temporal_data_v2.py cc_news --force

TiC-LM daily slices:

    python scripts/process_temporal_data_v2.py tic_lm --force
...
from data.temporal_processing_v2 import (
    DEFAULT_CC_NEWS_RAW,
